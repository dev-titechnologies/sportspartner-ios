...
#else++uiyq1+	#define MB_AUTORELEASE(exp) [exp autorelease]
...
@property(nonatomic,retain)Styles *style;
...
@synthesize animationType,style;
@synthesize delegate;
@synthesize opacity;
@synthesize color;
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
        ...
        self.activityIndicatorColor = [UIColor clearColor];
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
