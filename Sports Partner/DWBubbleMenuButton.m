...
- (void)showButtons
{
    ...
    for (int i = 0; i < buttonContainer.count; i++) {
        ...
        switch (self.direction)
        {
            ...
            case DirectionUp:
                originPosition = CGPointMake(140, self.frame.size.height - self.homeButtonView.frame.size.height);
            ...
            case DirectionDown:
                originPosition = CGPointMake(140, self.homeButtonView.frame.size.height);
                finalPosition = CGPointMake(self.frame.size.width/2.f,
...
- (void)dismissButtons
{
    ...
    self.userInteractionEnabled = NO;
     self.homeButtonView.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageNamed:@"b_view.png"]];
    [CATransaction begin];
    [CATransaction setAnimationDuration:_animationDuration];
    [CATransaction setCompletionBlock:^{
    ...
    for (int i = (int)_buttonContainer.count - 1; i >= 0; i--) {
        ...
        switch (self.direction) {
            ...
            case DirectionUp:
                finalPosition = CGPointMake(140, self.frame.size.height - self.homeButtonView.frame.size.height);
                break;
    ...
    switch (self.direction) {
        case DirectionUp:
        {
            self.homeButtonView.autoresizingMask = UIViewAutoresizingFlexibleTopMargin;
             self.homeButtonView.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageNamed:@"b_close.png"]];
